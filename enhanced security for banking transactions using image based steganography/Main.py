...
main = Tk()
main.title("Enhanced Security for banking transactions using image based steganography")
...
font = ('times', 15, 'bold')
title = Label(main, text='Enhanced Security for banking transactions using image based steganography')
